...
//     */
     ...
     *
     * Default draws text (aka character). Pen color is color used to draw whatever is asked since
     * its a static field. First background color is set then a square is filled. then color for text
     * is set and text is drawn with that color.
    ...
    public void draw(double x, double y) {
        ...
        StdDraw.filledSquare(x + 0.5, y + 0.5, 0.5); // the middle of the tile specified by x,y
